...
struct SettingsView: View {
    ...
    @AppStorage("packingweightly_showNotes") private var showNotes: Bool = true
    @AppStorage("packingweightly_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/packweight-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/packweight-app/terms.html")!)
